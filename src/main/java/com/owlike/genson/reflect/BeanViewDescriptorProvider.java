...
public class BeanViewDescriptorProvider extends BaseBeanDescriptorProvider {
    ...
    @SuppressWarnings("unchecked") @Override public <T> BeanDescriptor<T> provide(Class<T> ofClass,
        ...
        if (descriptor == null) {
            ...
            if (!ofClass.isAssignableFrom(parameterizedTypeForBeanView)) { throw new IllegalArgumentException(
    ...
    @Override public List<BeanCreator> provideBeanCreators(Type ofType, Genson genson) {
    ...
    public static class BeanViewPropertyFactory implements BeanPropertyFactory {
        ...
        @Override public PropertyAccessor createAccessor(String name, Field field, Type ofType,
                Genson genson) {
            return null;
        }

        @Override public BeanCreator createCreator(Type ofType, Constructor<?> ctr,
                String[] resolvedNames, Genson genson) {
            return null;
        }

        @Override public BeanCreator createCreator(Type ofType, Method method,
                String[] resolvedNames, Genson genson) {
            return null;
        }

        @Override public PropertyMutator createMutator(String name, Field field, Type ofType,
                Genson genson) {
            return null;
        }
    }
    ...
    private static class BeanViewPropertyAccessor extends MethodAccessor {
        ...
        @Override public Object access(Object target) {
            try {
    ...
    private static class BeanViewPropertyMutator extends MethodMutator {
        ...
        @Override public void mutate(Object target, Object value) {
            try {
