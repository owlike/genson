...
public class DefaultConvertersTest {
    ...
    @Test public void testRoundTripOfLinkedList() {
        testCollectionImplementationsRoundTrip(LinkedList.class);
    }

    @Test public void testRoundTripOfTreeSet() {
        testCollectionImplementationsRoundTrip(TreeSet.class);
    }

    @Test(expected = JsonBindingException.class) public void testSerializationOfSortedSetWithComparatorShouldFail() {
    ...
    @Test public void testRoundTripOfLinkedHashSet() {
        testCollectionImplementationsRoundTrip(LinkedHashSet.class);
    }

    @Test public void testRoundTripOfArrayDeque() {
        testCollectionImplementationsRoundTrip(ArrayDeque.class);
    }

    @Test public void testRoundTripOfPriorityQueue() {
        testCollectionImplementationsRoundTrip(PriorityQueue.class);
    }

    @Test public void testRoundTripOfTreeMap() {
        testMapImplementationsRoundTrip(TreeMap.class);
    }

    @Test public void testRoundTripOfLinkedHashMap() {
    ...
    public void testCalendarConverter() {
        Genson genson = new GensonBuilder().useDateAsMillis(true).create();
