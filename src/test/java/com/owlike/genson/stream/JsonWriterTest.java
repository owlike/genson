...
public class JsonWriterTest {
    ...
    @Test(expected = JsonStreamException.class) public void testPreventInvalidJsonOutputInObject()
            throws IOException {
        w.beginObject().writeValue("must fail");
    }

    @Test(expected = JsonStreamException.class) public void testPreventInvalidJsonOutputInArray()
            throws IOException {
    ...
    @Test(expected = JsonStreamException.class) public void testExpectNameInObject()
            throws IOException {
        w.beginObject().beginArray();
    }

    @Test public void testWriteMetadataWithBeginObject() throws IOException {
    ...
    @Test public void testArrayMetadataMustSkipSilently() throws IOException {
    ...
    @Test public void testLiteralMetadataMustSkipSilentlyInArray() throws IOException {
        w.beginArray().beginNextObjectMetadata().writeMetadata("a", "ooooo").writeValue(true)
                .beginObject().endObject().endArray().flush();
        assertEquals("[true,{}]", sw.toString());
    }

    @Test public void testWriteMetadataWithBeginNextObjectMetadata() throws IOException {
        try {
    ...
    @Test public void testWriteMetadataWithBeginNextObjectMetadata2() throws IOException {
        String expected = "{\"@doc\":\"My doc\",\"name\":null}";
    ...
    @Test public void testWriteMetadataWithMultipleBeginNextObjectMetadata() throws IOException {
    ...
    @Test(expected=NumberFormatException.class) public void testDoubleNanThrowsException() throws IOException {
        w.writeValue(Double.NaN);
    }
    
    @Test(expected=NumberFormatException.class) public void testFloatNaNThrowsException() throws IOException {
        w.writeValue(Float.NaN);
    }
    
    @Test(expected=NumberFormatException.class) public void testDoubleInfinityhrowsException() throws IOException {
