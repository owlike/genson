...
@RunWith(value = org.junit.runners.Parameterized.class) public class GensonJsonParserTest {
    ...
    @Test public void testRootArrayAndNestedObjects() throws IOException {
        JsonParser parser =
    ...
    @Test(expected = JsonException.class) public void testIncompleteSource() throws IOException {
